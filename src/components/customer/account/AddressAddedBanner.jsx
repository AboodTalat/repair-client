...
// Confirmation toast shown after a new address is added — mirrors CardAddedBanner
// (Figma 79:3555). Same dark slab chrome; only the copy differs. Auto-dismisses
// after 3s.

export default function AddressAddedBanner({ visible, onDismiss }) {
  useEffect(() => {
