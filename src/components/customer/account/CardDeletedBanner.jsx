...
// Confirmation toast shown after a payment method is removed — Figma 79:3063.
// Same dark slab chrome as CardAddedBanner; only the copy differs. Auto-
// dismisses after 3s.

export default function CardDeletedBanner({ visible, onDismiss }) {
  useEffect(() => {
  ...
  // `fixed` rather than `sticky` for the same reason as CardAddedBanner.
  return (
    <div
      role="status"
      aria-live="polite"
